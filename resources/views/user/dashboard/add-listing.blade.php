                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control"
                                        id="exampleInputEmail1" placeholder="Enter Company Name" name="company" required>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <label for="on">ON</label> <input id="on1" type="radio" name="1" checked>
                                         <label for="off">OFF</label> <input id="off1" value="CLOSED" type="radio"  name="1"> <br>
                                          <div id="show1">
                                              Start:
                                              <input type="time" name="sunday_start" id="sunday_start" required >
                                              <br> <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="" class="form-control"
                                    id="exampleInputEmail1" placeholder="Enter Total Employees Number Here" name="employe">
                                </div>
                                <div class="form-group">
