...
<option value="{{ $value->id }}" @if($listing_data->cat_id==$value->id) selected @endif >{{ $value->category_name }}</option>
                                ...
                                <table class="table table-stripe"  style="display: flex; overflow:scroll;">
                                    <tr>
                                        <th>Sunday</th>
                                        <th>Monday</th>
                                        <th>Tuesday</th>
                    ...
                    <textarea class="form-control" name="text" id="" cols="30" rows="8" placeholder="Type Client Review Text Here.."></textarea>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <label for="">Select Business Logo</label>
                            ...
                            <div class="form-group">
                                    <label for="exampleInputEmail1"> Gallery Image 1 <small>(If you don't change the photo, the previous photo will remain ..)</small></label>
                                    <input type="file" id="" class="form-control"
                                    id="exampleInputEmail1" name="gallery1">
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1"> Gallery Image 2 <small>(If you don't change the photo, the previous photo will remain ..)</small></label>
                                    <input type="file" id="" class="form-control"
                                    id="exampleInputEmail1" name="gallery2">
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1"> Gallery Image 3 <small>(If you don't change the photo, the previous photo will remain ..)</small></label>
                                    <input type="file" id="" class="form-control"
                                    id="exampleInputEmail1" name="gallery3">
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1"> Gallery Image 4 <small>(If you don't change the photo, the previous photo will remain ..)</small></label>
                                    <input type="file" id="" class="form-control"
